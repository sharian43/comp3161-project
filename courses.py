...
# student_sql_file = "cms_student.sql"
...
# with open(student_sql_file, "w") as f:
#     for student in students:
#             f.write(f"INSERT INTO Student (StudentID, FirstName, LastName, department, gpa) VALUES ({student['student_id']}, '{student['first_name']}', '{student['last_name']}', '{student['department']}', '{student['gpa']}');\n")

print(f"SQL files '{lecturer_sql_file}', '{course_sql_file}' generated successfully!")
